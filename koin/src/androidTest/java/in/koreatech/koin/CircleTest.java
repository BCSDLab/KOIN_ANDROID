...
public class CircleTest {
    ...
    @Test
    public void testcaseForCategoryAll() {
    ...
    @Test
    public void testcaseForCategoryArt() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
    ...
    @Test
    public void testcaseForCategoryShow() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
    ...
    @Test
    public void testcaseForCategorySport() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
    ...
    @Test
    public void testcaseForCategoryReligion() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
    ...
    @Test
    public void testcaseForCategoryStudy() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
    ...
    @Test
    public void testcaseForCategoryService() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
    ...
    @Test
    public void testcaseForCategoryEtc() {
        //NestedScrollView 버튼 mismatch 문제를 해결하기 위해 추가함
        onView(withId(R.id.circle_layout)).perform(ViewActions.swipeDown());
