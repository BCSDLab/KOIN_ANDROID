...
public class LandTest {
    @Rule
    public IntentsTestRule<LandActivity> activityRule =
            new IntentsTestRule<>(LandActivity.class);
    ...
    public void testCaseForRecyclerScroll(){
        ...
        onView(withId(R.id.land_recyclerlayout)).inRoot(RootMatchers.withDecorView(
