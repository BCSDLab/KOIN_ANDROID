...
import in.koreatech.koin.service_lostfound.ui.LostFoundDetailActivity;
import in.koreatech.koin.service_search.adapters.SearchResultAdapter;
import in.koreatech.koin.service_search.contracts.SearchResultContract;
import in.koreatech.koin.service_search.presenters.SearchResultPresenter;
...
public class SearchResultFragment extends Fragment implements SwipeRefreshLayoutBottom.OnRefreshListener, SearchResultContract.View {
    ...
    public void onRefresh() {
        if (totalPage >= currentPage + 1) {
            ...
            ToastUtil.makeShortToast(getActivity(), "마지막 검색 결과입니다.");
    ...
    public void showMessage(String message) {
        ToastUtil.makeShortToast(getActivity(), message);
    }
