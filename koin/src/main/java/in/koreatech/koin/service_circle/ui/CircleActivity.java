package in.koreatech.koin.service_circle.ui;
...
import in.koreatech.koin.service_circle.adapters.CircleRecyclerAdapter;
    ...
    public void goToCircleDetailActivity(int circleId, String circleName) {
        ...
        ActivityOptions options = ActivityOptions
                .makeSceneTransitionAnimation(this,
                        Pair.create(mKoinBaseAppbarDark, SHARE_VIEW_NAME_APP_BAR),
