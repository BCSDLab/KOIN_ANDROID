...
public class KoinNavigationDrawerActivity extends BaseNavigationActivity {
    ...
    protected void goToStoreActivity() {
        goToActivityFinish(new Intent(this, StoreFragment.class));
    }

    @Override
    protected void goToDiningActivity() {
        goToActivityFinish(new Intent(this, DiningFragment.class));
    }
    ...
    protected void goToLandActivity() {
        goToActivityFinish(new Intent(this, LandFragment.class));
    }

    protected void goToLostFoundActivity() {
        goToActivityFinish(new Intent(this, LostFoundMainFragment.class));
    }
