...
import in.koreatech.koin.service_used_market.presenters.MarketUsedDetailCommentPresenter;
...
public class MarketUsedDetailCommentActivity extends KoinNavigationDrawerActivity implements MarketUsedCommentContract.View, MarketUsedDetailCommentAdapter.OnCommentRemoveButtonClickListener {
    ...
    public void init() {
        ...
        if (mMarketID == 0)
            mKoinBaseAppBarDark.setTitleText("팝니다");
        else
            mKoinBaseAppBarDark.setTitleText("삽니다");
