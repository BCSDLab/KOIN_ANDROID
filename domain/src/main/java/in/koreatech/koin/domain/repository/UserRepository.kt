...
interface UserRepository {
    ...
    suspend fun verifyCertificationCode(phoneNumber: String, verificationCode: String): Result<Unit>

    suspend fun verifyEmailCode(email: String, verificationCode: String): Result<Unit>
