...
const val BUS_REMAIN_TIME_UPDATE_PERIOD: Long = 60 * 60 * 1000

const val STORE_RECOMMEND_STORES = 3

const val STORE_MENU_IMAGE_MAX = 3
const val SIGN_UP_IMAGE_MAX = 5
