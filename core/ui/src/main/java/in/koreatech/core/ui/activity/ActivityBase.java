package in.koreatech.core.ui.activity;
...
import in.koreatech.core.ui.progress.CustomProgressDialog;
import in.koreatech.core.ui.progress.IProgressDialog;
...
public class ActivityBase extends AppCompatActivity implements IProgressDialog {
    ...
    public void showProgressDialog(@StringRes int resId) {
        if (customProgressDialog == null) {
            customProgressDialog = new CustomProgressDialog(this, getResources().getString(resId));
            customProgressDialog.execute();
        }
    }
