...
import `in`.koreatech.koin.core.designsystem.component.StableIcon
    ...
    Column(
        ...
        Row(
            ...
            StableIcon(
                ...
                modifier = Modifier.clickable { onClickSettingIcon() }
            )
            ...
            TextField(
                ...
                trailingIcon = {
                    StableIcon(
                        ...
                        tint = Color(0xFFB5C1Cd),
                        modifier = Modifier.clickable { onClickSearchIcon() }
                    )
                },
                modifier = Modifier
                    .fillMaxWidth()
