...
@Composable
fun AppliedRecruitmentEmptyState(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
        ...
        Text(
            text = stringResource(R.string.recruitment_applied_empty_title),
        ...
        Text(
            text = stringResource(R.string.recruitment_applied_empty_subtitle),
...
@Composable
private fun AppliedRecruitmentEmptyStatePreview() {
    RebrandKoinTheme {
