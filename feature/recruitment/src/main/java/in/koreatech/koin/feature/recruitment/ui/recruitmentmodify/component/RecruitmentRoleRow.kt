        ...
        Row(
            ...
            BasicTextField(
                ...
                onValueChange = { newValue ->
                    onNameChange(newValue.take(RecruitmentModifyRole.NAME_MAX_LENGTH))
                },
                singleLine = true,
            ...
            Text(
                text = "${role.name.length}/${RecruitmentModifyRole.NAME_MAX_LENGTH}",
...
private fun RecruitmentRoleRowPreview() {
    RebrandKoinTheme {
        RecruitmentRoleRow(
            role = RecruitmentModifyRole(name = "PM", count = 2),
            onNameChange = {},
            onCountChange = {},
            onRemove = {}
        )
