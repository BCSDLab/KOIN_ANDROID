...
internal val shuttleSemesterMock =
    ShuttleSemesterState(
        name = "정규학기",
        from = LocalDate.parse("2024-09-01"),
        to = LocalDate.parse("2024-12-21")
    )

internal val shuttleCourseRouteMock1 =
...
internal val shuttleCourseRouteMock2 =
    ShuttleCourseRouteState(
        id = "1",
...
internal val shuttleCourseRouteMock3 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "터미널",
...
internal val shuttleCourseRouteMock4 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "두정역",
...
internal val shuttleCourseRouteMock5 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "아산 / KTX",
...
internal val shuttleCourseRouteMock6 =
    ShuttleCourseRouteState(
        id = "1",
...
internal val shuttleCourseRouteMock7 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKEND,
...
internal val shuttleCourseRouteMock8 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKEND,
...
internal val shuttleCourseRouteMock9 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.CIRCULATION,
        routeName = "청주셔틀",
...
internal val shuttleCourseRouteMock10 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "용암동",
...
internal val shuttleCourseRouteMock11 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "동남지구",
...
internal val shuttleCourseRouteMock12 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "산남/분평",
...
internal val shuttleCourseRouteMock13 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "서울 교대역",
...
internal val shuttleCourseRouteMock14 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "서울 교대역",
...
internal val shuttleCourseRouteMock15 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "서울 동천역",
...
internal val shuttleCourseRouteMock16 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "서울 하교 1",
...
internal val shuttleCourseRouteMock17 =
    ShuttleCourseRouteState(
        id = "1",
        type = ShuttleBusOperationType.WEEKDAY,
        routeName = "서울 하교 2",
...
internal val shuttleCoursesMock =
    ShuttleCoursesState(
        courses =
        mapOf(
            ShuttleCourseRegionState("천안・아산") to
                listOf(
            ...
            ShuttleCourseRegionState("청주") to
                listOf(
            ...
            ShuttleCourseRegionState("서울") to
                listOf(
