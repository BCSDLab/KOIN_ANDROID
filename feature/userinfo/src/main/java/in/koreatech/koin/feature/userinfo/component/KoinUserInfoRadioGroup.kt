 ...
 */
@Composable
fun KoinUserInfoSingleChoiceRadioGroup(
...
@Preview
@Composable
private fun KoinUserInfoSingleChoiceRadioGroupPreview() {
...
@Preview
@Composable
private fun KoinUserInfoRadioButtonPreview() {
    KoinUserInfoRadioButton(
        text = "Option 1",
        selected = true,
        onSelected = {}
