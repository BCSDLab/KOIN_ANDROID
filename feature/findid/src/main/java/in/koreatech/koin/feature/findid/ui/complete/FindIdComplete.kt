package `in`.koreatech.koin.feature.findid.ui.complete
...
import `in`.koreatech.koin.feature.findid.util.stringResourceWithStyle
...
fun FindIdCompleteImpl(
    ...
    Column(
        ...
        FilledButton(
            ...
            onClick = {
                Intent(Intent.ACTION_VIEW).apply {
                    data = "koin://findpassword/activity".toUri()
                }.let {
                    context.startActivity(it)
                }
                (context as Activity).finish()
