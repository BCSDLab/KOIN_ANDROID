...
enum class OrderHistoryStatus(@StringRes val stringRes: Int, val isActivated: Boolean) {
    CANCELED(R.string.order_history_status_canceled, false), // 주문 취소
...
enum class OrderInProgressStatus(@StringRes val stringRes: Int, @StringRes val stringResMessage: Int, val showTime: Boolean = false) {
