...
/**
 * Koin Find Password Password Text Field Component
 ...
 */
@Composable
fun KoinFindPasswordPasswordTextField(
    value: String,
            ...
            Column(
                ...
                Row(
                    ...
                    Image(
                        ...
                        painter = painterResource(id = if (showPassword) R.drawable.ic_find_password_hide_password else R.drawable.ic_find_password_show_password),
...
@Preview
@Composable
private fun KoinFindPasswordPasswordTextFieldPreview() {
