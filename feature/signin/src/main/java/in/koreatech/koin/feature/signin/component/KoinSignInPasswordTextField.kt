...
/**
 * Koin Sign In Password Text Field Component
 ...
 */
@Composable
fun KoinSignInPasswordTextField(
    value: String,
            ...
            Column(
                ...
                Row(
                    ...
                    Image(
                        ...
                        painter = painterResource(id = if (showPassword) R.drawable.ic_sign_in_hide_password else R.drawable.ic_sign_in_show_password),
...
@Preview
@Composable
private fun KoinSignInPasswordTextFieldPreview() {
