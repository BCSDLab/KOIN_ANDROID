...
data class AccountSetupState(
    ...
    val verifyState: SignupContinuationState = SignupContinuationState.PhoneNumberAvailable,
    val phoneNumberState: SignupContinuationState = SignupContinuationState.PhoneNumberAvailable,
