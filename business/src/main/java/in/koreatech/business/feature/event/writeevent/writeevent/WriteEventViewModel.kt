...
class WriteEventViewModel
    ...
    constructor(
        ...
        fun onCalendarVisibilityChanged(visibility: Boolean) =
            intent {
                reduce {
        ...
        fun onDatePickerVisibilityChanged(visibility: Boolean) =
            intent {
                reduce {
        ...
        fun onSelectedYearMonthChanged(yearMonth: YearMonth) =
            intent {
                reduce {
