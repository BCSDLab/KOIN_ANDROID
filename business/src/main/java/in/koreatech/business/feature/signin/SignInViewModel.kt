...
class SignInViewModel
    ...
    constructor(
        ...
        override val container =
            container<SignInState, SignInSideEffect>(
                SignInState(),
            )
        ...
        private fun navigateToMain(isFirst: Boolean) =
            intent {
                if (isFirst) {
        ...
        private fun showErrorMessage() {
            intent {
                ...
                if (state.id.isBlank()) {
                    postSideEffect(SignInSideEffect.ShowNullMessage(ErrorType.NullPhoneNumber))
